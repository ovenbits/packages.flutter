...
class _PdfViewPinchState extends State<PdfViewPinch> with SingleTickerProviderStateMixin {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return InteractiveViewer(
          ...
          constrained: false,
          alignPanAxis: false,
          boundaryMargin: _minScale < 1 ? const EdgeInsets.all(double.infinity) : EdgeInsets.zero,
          minScale: _minScale,
          maxScale: _maxScale,
          panEnabled: true,
          scaleEnabled: true,
